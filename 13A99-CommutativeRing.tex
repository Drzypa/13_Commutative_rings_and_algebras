...
\usepackage{pmmeta}
\pmcanonicalname{CommutativeRing}
\pmcreated{2013-11-12 18:26:58}
\pmmodified{2013-11-12 18:26:58}
\pmowner{drini}{3}
\pmmodifier{pahio}{2872}
\pmtitle{commutative ring}
\pmrecord{8}{35169}
\pmprivacy{1}
\pmauthor{drini}{2872}
\pmtype{Definition}
...
This needs not to happen for ``$\cdot$''.  Rings $R$ where 
``$\cdot$'' is commutative, that is, 
$x\!\cdot\!y = y\!\cdot\!x$ 
for all $x,y\in R$, are called commutative rings.
...
\PMlinkname{two-sided}{Ideal}, the 
these rings are more comfortable to handle than other rings.


The study of commutative rings is called {\it commutative algebra}.
%%%%%
%%%%%
\end{document}
